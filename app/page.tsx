        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2">
              <div className="relative w-full h-[400px] md:h-[450px] rounded-lg shadow-lg overflow-hidden">
                <Image
                  ...
                  loading="eager" // Carrega esta imagem importante rapidamente
                />
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 relative aspect-video rounded-xl overflow-hidden shadow-xl">
              ...
              <Image
                src={`https://img.youtube.com/vi/_nZTxmazs8Y/maxresdefault.jpg`}
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Artigos Recentes</h2>
            </div>
            <Link href="/blog" className="text-blue-600 dark:text-blue-400 font-medium inline-flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <Link href={`/blog/artigo-${item}`} key={item} className="group">
                <div className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                  <div className="relative h-48 overflow-hidden">
                    <Image
                      src={`/placeholder.svg?height=192&width=384&text=Blog+${item}`}
                      alt={`Artigo ${item}`}
                      fill
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400">5 min de leitura</span>
                    </div>
                    <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                      Como a IA está transformando o atendimento ao cliente
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Descubra como empresas estão utilizando inteligência artificial para melhorar a experiência do
                      cliente...
                    </p>
                  </div>
                </div>
